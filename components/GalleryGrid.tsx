...
import { safeGetJSON } from '@/lib/localStorage'
...
export function GalleryGrid() {
  ...
  useEffect(() => {
    // Load any saved AI packages from localStorage and merge with sample posts
    const timer = setTimeout(() => {
      const stored = safeGetJSON<Post[]>('ai_content_packages') || []
      // stored likely contains our AI packages; ensure type compatibility
      const merged = [...stored, ...(samplePosts as Post[])]
      setPosts(merged)
    }, 500)
